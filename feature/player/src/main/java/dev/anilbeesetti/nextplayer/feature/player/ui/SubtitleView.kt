...
import dev.anilbeesetti.nextplayer.feature.player.service.AssSubtitleState
...
fun SubtitleView(
    ...
    val assHandler by AssSubtitleState.handler.collectAsState()
