...
class TopLevelNavigationTest {
    ...
    @Test
    fun historyAndPlaylistsAreIncludedAsTopLevelDestinations() {
        assertEquals(
            listOf(
    ...
    @Test
    fun topLevelContentKeysMatchNavigation3DefaultKeys() {
        ...
        TopLevelDestination.entries.forEach { destination ->
            assertEquals(true, navigation3DefaultContentKey(destination.route) in state.topLevelContentKeys)
        }
    }
